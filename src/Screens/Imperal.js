...
class Imperal extends Component {
  state = {
    heightSliderValue: 70,
    weightSliderValue: 165,
    man: true,
  };
  ...
  heightIncrease = () => {
    if (this.state.heightSliderValue < 84) {
      this.setState({
  ...
  heightDecrease = () => {
    if (this.state.heightSliderValue > 56) {
      this.setState({
        heightSliderValue: (this.state.heightSliderValue * 10 - 2) / 10,
      });
    }
  ...
  weightIncrease = () => {
    if (this.state.weightSliderValue < 275) {
      this.setState({
  ...
  weightDecrease = () => {
    if (this.state.weightSliderValue > 55) {
      this.setState({
        weightSliderValue: (this.state.weightSliderValue * 10 - 2) / 10,
      });
    }
  ...
  calculate = () => {
    var h = this.state.heightSliderValue * this.state.heightSliderValue;
    var w = this.state.weightSliderValue;
    var bmi = Math.round((w * 703) / h);
    this.props.NEW(bmi);
...
export default connect(mapStateToProps, mapDispatchToProps)(Imperal);
